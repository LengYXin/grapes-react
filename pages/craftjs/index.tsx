...
import { Element, Editor, Frame, useNode } from "@craftjs/core"
...
export default class App extends React.Component<IAppProps> {
  ...
  public render() {
    // const resolver = {
    //   Container: createResolver(Container, 'Container'),
    //   Layout: createResolver(Layout, 'Layout'),
    //   Button: createResolver(Button, 'Button')
    // }
    return (
